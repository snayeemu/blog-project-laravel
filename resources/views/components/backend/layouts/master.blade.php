...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <x-backend.partials.top_bar></x-backend.partials.top_bar>
        <div id="layoutSidenav">
            <x-backend.partials.side_bar></x-backend.partials.side_bar>
            ...
            <main>
                ...
                <x-backend.partials.footer></x-backend.partials.footer>
            </div>
        </div>
